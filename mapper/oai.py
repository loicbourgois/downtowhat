...
class Openai():
    ...
    def query_openai_chat_conversation_async(
        ...
        return self.query_openai_chat_conversation(messages, model, max_retry, backoff, request_timeout)
    ...
    def query_openai_chat_conversation(
        ...
        try:
            ...
            return self.query_openai_chat_conversation(messages, model, max_retry-1, backoff*2)
